  ...
  var result = {
    ...
    parse: function(input, startRule) {
      ...
      function parse_metric_additive_expression() {
        ...
        var result2 = result1 !== null
          ? (function(head, tail) {
            return compoundMetric(head, tail);
          })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
      ...
      function parse_metric_primary_expression() {
        ...
        var result14 = result13 !== null
          ? (function(reduce, event) {
            event.reduce = reduce;
            event.source = input.substring(savedPos3, pos); return event;
          })(result13[0], result13[4])
          : null;
        if (result14 !== null) {
      ...
      function parse_event_filter_expression() {
        ...
        var result2 = result1 !== null
          ? (function(op, member, value) {
            return function(o) {
              op(o, member.field, value);
            };
          })(result1[0], result1[4], result1[8])
          : null;
        if (result2 !== null) {
          var result0 = result2;
        } else {
      ...
      function parse_event_additive_expression() {
        ...
        var result2 = result1 !== null
          ? (function(head, tail) {
            return compoundValue(head, tail);
          })(result1[0], result1[1])
          : null;
        if (result2 !== null) {
          var result0 = result2;
      ...
      function parse_array_literal() {
        ...
        var result9 = result8 !== null
          ? (function(first, rest) {
            return [first].concat(rest.map(function(d) {
              return d[3];
            }));
          })(result8[2], result8[3])
          : null;
      ...
      var filterEqual = function(o, k, v) {
          o[k] = v;
        };
      var filterGreater = filter('$gt');
      var filterGreaterOrEqual = filter('$gte');
      var filterLess = filter('$lt');
      var filterLessOrEqual = filter('$lte');
      var filterNotEqual = filter('$ne');
      var filterRegularExpression = filter('$regex');
      var filterIn = filter('$in');
      var exists = {
          $exists: true
        };
      ...
      function member(head, tail) {
        ...
        var shortName = fields.filter(function(d) {
            return !d.array;
          }).join('.');
        var longName = fields.join('.');
        var i = -1;
        var n = fields.length;
